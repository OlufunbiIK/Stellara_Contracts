...
export class AddTenantSchema1737456789000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.createTable(new Table({
            ...
            columns: [
                ...
                },
                {
                    name: 'metric',
                    type: 'enum',
                    enum: ['api_calls', 'storage_bytes', 'users_count', 'transactions', 'workflow_executions']
                },
                {
                    name: 'value',
                    type: 'bigint'
        ...
        await queryRunner.createForeignKey('tenant_usage', new TableForeignKey({
            columnNames: ['tenantId'],
            referencedColumnNames: ['id'],
            referencedTableName: 'tenants',
            onDelete: 'CASCADE'
        ...
        await queryRunner.createForeignKey('tenant_invitations', new TableForeignKey({
            columnNames: ['tenantId'],
            referencedColumnNames: ['id'],
            referencedTableName: 'tenants',
            onDelete: 'CASCADE'
        ...
        await queryRunner.createIndex('tenant_configs', new TableIndex({
        ...
        await queryRunner.createIndex('tenant_usage', new TableIndex({
        ...
        await queryRunner.createIndex('tenant_invitations', new TableIndex({
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.dropIndex('tenant_invitations', 'IDX_TENANT_INVITATIONS_EMAIL');
        await queryRunner.dropIndex('tenant_invitations', 'IDX_TENANT_INVITATIONS_TOKEN');
        await queryRunner.dropIndex('tenant_invitations', 'IDX_TENANT_INVITATIONS_TENANT_ID');
        ...
        const tableNames = ['tenant_configs', 'tenant_usage', 'tenant_invitations', 'users'];
        for (const tableName of tableNames) {
            const table = await queryRunner.getTable(tableName);
            if (table) {
              const foreignKeys = table.foreignKeys.filter(fk => fk.columnNames.indexOf('tenantId') !== -1);
